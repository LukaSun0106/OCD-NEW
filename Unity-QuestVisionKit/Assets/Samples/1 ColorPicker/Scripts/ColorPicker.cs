...
public class ColorPicker : MonoBehaviour
{
    ...
    private void PickColor()
    {
        ...
        // Spawn the cube at the hit point
        SpawnCubeAtWorldPosition(_lastHitPoint.Value);
    }
    ...
    private void SpawnCubeAtWorldPosition(Vector3 worldPosition)
    {
        if (cubePrefab == null)
        {
            Debug.LogWarning("ColorPicker: No cube prefab assigned.");
            return;
        }
